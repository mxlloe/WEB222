...
window.onload = function(){
    ...
    var tableContainer1 = document.querySelector("#Tablecontainer");

    var table1 = "<table border>";

    table1 += "<tr>" + "<th> First Name </th>" + "<th> Last Name </th>" + "<th> Age </th>" + "<th> Email </th>" + "</tr>"; 

    for(var i = 0; i < users.length; i++)
    {   
         table1 += "<tr>"+ "<td>" + users[i].first_name +  "</td>" + "<td>" + users[i].last_name +  "</td>" + "<td>" + users[i].age +  "</td>";

         table1 += "<td>" + "<a href= mailto:someone@gmail.com>" + users[i].email + "</a>" +  "</td>" + "</tr>";
    }
